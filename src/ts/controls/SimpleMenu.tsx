        ...
        const menuItems = _.map(this.props.menuItems, (item, index) => {
            ...
            return (
                ...
                >
                    ...
                    {item.text === 'Home' ? <AiFillHome style={{ marginLeft: 20, width: 20, height: 20 }} /> : null}
                    {item.text === 'Video NFT' ? <ImVideoCamera style={{ marginLeft: 20, width: 20, height: 20 }} /> : null}
                    {item.text === 'Audio NFT' ? <MdAudiotrack style={{ marginLeft: 20, width: 20, height: 20 }} /> : null}
                    {item.text === 'Image NFT' ? <BsImages style={{ marginLeft: 20, width: 20, height: 20 }} /> : null}
                    {item.text === '3D Object NFT' ? <MdPermMedia style={{ marginLeft: 20, width: 20, height: 20 }} /> : null}

                    {item.text === 'Swap' ? <AiOutlineSwap style={{ marginLeft: 20, width: 20, height: 20 }} /> : null}
                    {item.text === 'Initial Coin Offering' ? <MdLocalOffer style={{ marginLeft: 20, width: 20, height: 20 }} /> : null}
